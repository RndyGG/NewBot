        ...
        case 'stiker': {
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                client.sendImageAsSticker(from, imageBase64).then(() => {
                    client.reply(from, 'Sticker Telah Dibuat')
                ...
                */
                client.reply(from, 'Tidak bisa digunakan', id)
                ...
                client.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ...
                    : client.reply(from, 'Sticker Telah Dibuat')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
